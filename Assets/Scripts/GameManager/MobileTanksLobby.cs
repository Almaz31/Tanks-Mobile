...
public class MobileTanksLobby : MonoBehaviour
{
    private const string KEY_RELAY_JOIN_CODE = "RelayJoinCode";
    public static MobileTanksLobby Instance { get; private set; }
    ...
    private async Task<Allocation> AllocateRelay()
    {
        try
        {
            Allocation allocation = await RelayService.Instance.CreateAllocationAsync(TanksMobileMultiplayer.MAX_PLAYER_AMOUNT - 1);
    ...
    public async void CreateLobby(string lobbyName,bool isPrivate)
    {
        ...
        try {
            joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, TanksMobileMultiplayer.MAX_PLAYER_AMOUNT, new CreateLobbyOptions { IsPrivate = isPrivate });
